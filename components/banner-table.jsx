...
export function BannersTable() {
  ...
  const handlePageChange = (pageIndex) => {
    ...
    loadBanners(newPage, pagination.perPage, debouncedSearchTerm);
  };
  ...
  const handlePageSizeChange = (newPageSize) => {
    ...
    loadBanners(1, newPageSize, debouncedSearchTerm);
  };
  ...
  const columns = [
    {
      ...
      cell: ({ row }) => {
        ...
        const imageUrl = banner.image?.url || "/placeholder-image.jpg";
        return (
    ...
    return (
      <div className="text-center py-10 text-red-500">
        ...
        <Button
          ...
          className="ml-4"
          onClick={() =>
            loadBanners(1, pagination.perPage, debouncedSearchTerm)
          }
        >
          Retry
        </Button>
